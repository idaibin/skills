...
ASK_AI_CLI_MONITOR_TOKENS = (
    ...
    "exact fingerprint and profile digest",
    "`compatible-drift`",
    "SemVer alone",
    "at most once per new",
    "## Adaptive Monitoring",
    "about one minute",
    "about five minutes",
    "scheduling examples, not fixed limits",
    "quiet poll keeps the operation `running`",
    "delegated CLI executor",
    "exactly one process start",
    "effective runtime identity is verified before delegation",
    "provider result content remains unread by the executor",
    "retrieves the result",
    "do not silently run locally or substitute another executor",
...
ASK_AI_CLI_HANDOFF_TOKENS = (
    ...
    "coordinator-contract append-only observations",
    ...
    "runtime-verified delegated CLI executor",
    "reports only process/session",
    "primary coordinator independently retrieves and reads the final result",
