...
PROTOCOLS = {
    Path("protocols/frontend-css-governance-v1.md"): (
        ...
        Path("skills/repo-audit/references/frontend-css-governance.md"),
    ...
    Path("protocols/openapi-contract-governance-v1.md"): (
        ...
        Path("skills/repo-audit/references/openapi-contract-governance.md"),
    ...
    Path("protocols/frontend-visual-evidence-v1.md"): (
        ...
        Path("skills/repo-audit/references/frontend-visual-evidence.md"),
    ...
    Path("protocols/frontend-visual-evidence-v1.schema.json"): (
        ...
        Path("skills/repo-audit/assets/frontend-visual-evidence.schema.json"),
    ...
    Path("scripts/validate-frontend-visual-evidence.py"): (
        ...
        Path("skills/repo-audit/scripts/validate-frontend-visual-evidence.py"),
    ...
    Path("protocols/frontend-layout-governance-v1.md"): (
        ...
        Path("skills/repo-audit/references/frontend-layout-governance.md"),
    ),
    Path("protocols/visual-direction-and-anti-slop-v1.md"): (
        ...
        Path("skills/repo-audit/references/visual-direction-and-anti-slop.md"),
    ),
    Path("protocols/specification-authorities-v1.md"): (
        Path("skills/dev-frontend/references/specification-authorities.md"),
        Path("skills/repo-audit/references/specification-authorities.md"),
    ),
    ...
    Path("protocols/behavior-first-v1.md"): (
        ...
        Path("skills/dev-typescript/references/behavior-first.md"),
    ),
    Path("protocols/codebase-design-v1.md"): (
        ...
        Path("skills/dev-typescript/references/codebase-design.md"),
        Path("skills/repo-audit/references/codebase-design.md"),
    ...
    Path("protocols/code-quality-v1.md"): (
        ...
        Path("skills/dev-typescript/references/code-quality.md"),
        Path("skills/repo-audit/references/code-quality.md"),
    ...
    Path("protocols/java-engineering-v1.md"): (
        ...
        Path("skills/repo-audit/references/java-engineering.md"),
    ),
    Path("protocols/project-grounding-v1.md"): (
        ...
        Path("skills/dev-typescript/references/project-grounding.md"),
        Path("skills/repo-audit/references/project-grounding.md"),
