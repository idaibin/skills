...
| Upgrade/install | Compares only `skills/code-review/`, previews before writing, and uses `--check-target` after local install. | Overwrites directly or skips installed-target validation. |
