...
- Choose the browser in this order: requested or recorded session browser; browser/tab with the required session evidence; user's default browser such as Arc; approved Chrome/Chromium fallback.
