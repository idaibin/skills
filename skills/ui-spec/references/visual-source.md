...
Load this reference when qualifying or translating the source that the UI specification will implement.

## Accepted Source Types

- a user-selected Product Design image or prototype checkpoint;
- a supplied screenshot, mockup, design frame, or other visual target;
- an accepted current product surface;
- an accepted shared design-system revision.
...
Use verified product facts and accepted live component/token owners as authority when they conflict with pixels. Stop on a material unresolved conflict rather than silently changing the selected direction.
