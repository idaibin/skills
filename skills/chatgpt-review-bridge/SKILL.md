...
- Mark the bridge `Experimental` in reports whenever browser UI automation is used.
...
- Do not stage, commit, or push directly; use `code-delivery` as the sole Git mutation owner after local verification.
