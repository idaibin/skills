...
GitButler's app/package/API boundaries. See `frontend-reference-corpus.md`.
...
Select React, Vue Composition, Vue Options, or Repository-native Other and apply `frontend-framework-profiles.md`. Map component, hook/composable, store, router, provider, module, route, and cache lifetime only where the selected Architecture/Reuse profile needs it.
