...
4. Obtain a human selection through the host's structured question/select UI. Offer 2–3 mutually exclusive outcomes, such as preserve target intent, adopt source intent, or apply the stated synthesis; put the evidence-backed recommendation first and explain its impact. Group conflicts only when one decision genuinely governs them. If the UI is unavailable, ask one concise numbered-choice question and stop.
